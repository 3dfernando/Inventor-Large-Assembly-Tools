...
#Region "Variáveis e Objetos"
        ...
        Public Shared WithEvents BotaoAssemblyTools As ButtonDefinition
...
#Region "ApplicationAddInServer Members"
        ...
        Public Sub Activate(ByVal addInSiteObject As Inventor.ApplicationAddInSite, ByVal firstTime As Boolean) Implements Inventor.ApplicationAddInServer.Activate
            ...
            Dim IconePequeno3 As stdole.IPictureDisp =
                Microsoft.VisualBasic.Compatibility.VB6.IconToIPicture(
                New System.Drawing.Icon(My.Resources.AssemblyTools, 16, 16))

            Dim IconeGrande3 As stdole.IPictureDisp =
                Microsoft.VisualBasic.Compatibility.VB6.IconToIPicture(
